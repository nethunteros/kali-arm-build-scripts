...
nexmon="libgmp3-dev gawk qpdf bison flex make git libtool"
# kernel sauces take up space
size=7000 # Size of image in megabytes

packages="${arm} ${base} ${tools} ${services} ${extras} ${nexmon}"
architecture="armel"
...
OUTPUTFILE="${basedir}/kali-$1-rpi0w-nexmon.img"
